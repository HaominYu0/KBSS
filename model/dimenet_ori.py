...
class DimeNetPlusPlus(torch.nn.Module):
    ...
    def __init__(
        ...
        self.attn = nn.Sequential(nn.Linear(hidden_channels,hidden_channels),nn.LeakyReLU(inplace=True),nn.Linear(hidden_channels, hidden_channels))
    ...
    def triplets(self, edge_index, x_in, num_nodes):
        ...
        return col, row, idx_i, idx_j, idx_k, idx_kj, idx_ji, out_nodes_features, x_in
